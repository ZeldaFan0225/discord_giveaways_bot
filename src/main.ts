...
const keepAlive = async () => {
    ...
    //await connection.query("CREATE TABLE giveaways (id varchar(21) not null primary key, duration bigint not null, users text[] not null default '{}', prize text[] not null, winners int not null, auto_reroll boolean not null default FALSE, channel_id varchar(21) not null)")
